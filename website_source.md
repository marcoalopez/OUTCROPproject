...
The [Mineral Elastic Database (MED)]() is a database of the elastic properties of common rock-forming minerals created as part of this research project. This database differs from other existing ones in that it is a reactive database, i.e. a database made up of functions that return the elastic properties of minerals under specific conditions set by the user. The idea is to provide an up-to-date, well-documented database of elastic properties with rigorous tracking of changes (key to reproducibility). The database will be published at the end of the research project. For now, you can see an example of its use on the PyRockWave project website: https://deepnote.com/viewer/github/marcoalopez/PyRockWave/blob/main/src/example_database.ipynb (note: the MED will be independent of the PyRockWave project).
