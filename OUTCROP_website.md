...
**Marco A. Lopez-Sanchez** (PhD in Geology, 2013, Oviedo) is a hired researcher at the Department of Geology at University of Oviedo. He has 5 years of postdoctoral experience, 4 of which have been in the *Manteau et Interfaces* research group at Geosciences Montpellier (France) as a CNRS researcher, two of them linked to an MSCA-COFUND grant. Marco is an expert in microstructure and texture (CPO) analysis of solid materials (rocks, minerals, alloys) using _in situ_ and _ex situ_ experimental methods, Electron Backscatter Diffraction (EBSD), image analysis from different microscopy sources, digital image correlation (DIC) techniques, and modelling rock elastic properties (e.g. seismic wavespeeds and anisotropy). He also has extensive experience in programming (Python, Matlab) and code development for data analysis (https://github.com/marcoalopez). By 2022, he is starting a new research stage in Spain to develop the project OUTCROP as principal investigator.
...
**José A. Padrón-Navarta** (PhD in Geology, 2010, Granada) is a Ramón y Cajal research fellow at IACT-CSIC and a CNRS researcher at Géosciences Montpellier expert in phase equilibria and metamorphism of ultramafic rocks, fluid-rock interactions, and NAMs. After his PhD, he spent nearly four years in several postdoctoral positions (UGR, ANU Research School of Earth Sciences, Geosciences Montpellier) including a Marie Curie global fellowship, obtaining a full-time researcher position at the CNRS in 2014 (Géosciences Montpellier) and moved to IACT-CSIC in 2020. Within the OUTCROP project, he leads the FTIR analysis, metamorphic interpretation and thermodynamic modelling using Perple_X.
